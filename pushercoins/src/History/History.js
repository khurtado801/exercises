...
class History extends Component {
    ...
    // This function gets the price for yesterday
    getYesterdayPrice = () => {
    ...
    // This function gets the price for two days ago
    getTwoDaysPrice = () => {
        ...
        axios.all([this.getETHPrices(t), this.getBTCPrices(t), this.getLTCPrices(t)])
            .then(axios.spread((eth, btc, ltc) => {
                ...
                // Set the state of the twodayprice to the content of the object f
                this.setState({
                    twodaysprice: f
                });
    ...
    // This function gets the price for three days ago
    getThreeDaysPrice = () => {
        ...
        axios.all([this.getETHPrices(t), this.getBTCPrices(t), this.getLTCPrices(t)])
            .then(axios.spread((eth, btc, ltc) => {
                ...
                // Set the state of the threedayprice to the content of the object f
                this.setState({
                    threedaysprice: f
                });
    ...
    // This function gets the price for four days ago
    getFourDaysPrice = () => {
